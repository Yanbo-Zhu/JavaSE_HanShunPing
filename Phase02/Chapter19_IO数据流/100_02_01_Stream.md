...
//1. Was wird auf der Konsole ausgegeben? Geben Sie die genaue Reihenfolge der Ausgaben an.  
//2. Erläutern Sie, wie dieses Verhalten das Prinzip der Laziness in Java Streams widerspiegelt.  
//3. Wie würde sich das Verhalten unterscheiden, wenn Java Streams eager wären?  
//4. Welche Vorteile ergeben sich aus dem lazy Verhalten, insbesondere in Bezug auf Performance und Parallelisierung?  
    ...
    public static void main(String[] args) {  
        ...
        int result = numbers.stream()  
                ...
                .filter(n -> {  
                    ...
                    return n > 5;  
                })  // nur when n > 5, findFirst() will be executed  
                .findFirst()  
                .orElse(-1);  
