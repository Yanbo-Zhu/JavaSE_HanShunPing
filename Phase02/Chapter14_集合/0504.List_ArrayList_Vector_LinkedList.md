...
1. ArrayList中维护了一个Object类型的数组elementData: 
	...
	2. 对象在序列化的时候，transient修饰的属性不会被序列化  `transient：短暂的，瞬间的，表示该属性不会被序列化
3. 当创建ArrayList对象时，如果使用的是无参构造器，则初始elementData容量是0，(jdk7是10). 
	1. 第1次添加，则扩容elementData为10  ,如需再次扩容，则扩容elementData为1.5倍
