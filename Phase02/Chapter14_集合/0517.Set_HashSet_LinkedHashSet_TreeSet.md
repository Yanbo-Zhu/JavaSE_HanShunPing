...
(1)不允许元素重复，所以最多包含一个null.2. set 接口的实现类的对象(Set 接口对象), 不能存放重复的元素, 可以添加一个null
(2)JDK API中Set接口的实现类有:
![](image/Pasted%20image%2020230430205104.png)

(3)无序(添加和取出的顺序不一致)，没有索引
...
![](image/Pasted%20image%2020230502162231.png)
...
![](image/Pasted%20image%2020230502170852.png)



![](image/Pasted%20image%2020230502220558.png)
...
### 2.3.2 不仅打印顺序和插入顺序不一样，也不能添加重复元素
...
## 3.3 练习题 LinkedHashSetExercise.java
